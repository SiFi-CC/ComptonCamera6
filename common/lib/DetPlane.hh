...
public:
    DetPlane();
    DetPlane(Double_t a, Double_t b, Double_t c, Double_t d, Double_t dimZ, Double_t dimY,
             TString name);
    ~DetPlane();
...
private:
    ...
    Double_t fDimZ; ///< Size of the detector plane along Z axis (full length in mm)
