...
public:
  ...
  /** Create planar, rectangular source from configuration file, examples in data/sources/  */
...
private:
  ...
  /** linear energy distribution of gammas emitted from this source, if this option chosen */
  TF1* fEnergyDist = NULL;
  
  /** lower limit of energy of gammas emitted from this source, if continuous dist. */
  Double_t fMinEnergy;
  
  /** upper limit of energy of gammas emitted from this source, if continuous dist. */
  Double_t fMaxEnergy;
