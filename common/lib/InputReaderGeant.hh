...
private:
  ...
  PhysicVec*
      fRecoPosition_p; ///< Photon energy deposition position + uncertainty
...
inline int InputReaderGeant::GetNumberOfEventsInFile(void) {
...
inline TVector3* InputReaderGeant::GetPositionScattering(void) {
  return fPositionScat;
}
inline TVector3* InputReaderGeant::GetPositionAbsorption(void) {
  return fPositionAbs;
}
inline TVector3* InputReaderGeant::GetGammaDirScattered(void) {
  return fDirectionScat;
}
inline double InputReaderGeant::GetEnergyPrimary(void) {
  return fPrimaryEnergy;
}
inline double InputReaderGeant::GetEnergyLoss(void) { return fEnergyLoss; }
inline double InputReaderGeant::GetEnergyScattered(void) {
