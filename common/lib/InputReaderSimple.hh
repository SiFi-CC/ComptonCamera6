...
private:
  ...
  TVector3* fPoint1; ///< Coordinates of the interaction in the scatterer
                     ///< (Comptin scattering)
  TVector3*
      fPoint2; ///< Coordinates of the interaction in the absorber (absorption)
...
//------------------------------------------------------------------
inline TVector3* InputReaderSimple::GetPositionScattering(void) {
  return fPositionScat;
}
//------------------------------------------------------------------
inline TVector3* InputReaderSimple::GetPositionAbsorption(void) {
  return fPositionAbs;
}
//------------------------------------------------------------------
inline TVector3* InputReaderSimple::GetGammaDirPrimary(void) {
  return fVersor1;
}
//------------------------------------------------------------------
inline TVector3* InputReaderSimple::GetGammaDirScattered(void) {
  return fDirectionScat;
}
//------------------------------------------------------------------
inline double InputReaderSimple::GetEnergyPrimary(void) {
  return fPrimaryEnergy;
}
//------------------------------------------------------------------
inline double InputReaderSimple::GetEnergyLoss(void) { return fEnergyLoss; }
//------------------------------------------------------------------
inline double InputReaderSimple::GetEnergyScattered(void) {
