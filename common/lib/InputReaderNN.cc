...
InputReaderNN::InputReaderNN(TString path)
    : InputReader(path), fCorrectOnly(false), fX1(0), fY1(0), fZ1(0), fX2(0),
      fY2(0), fZ2(0), fX3(0), fY3(0), fZ3(0), fVX(0), fVY(0), fVZ(0), fVUncX(0),
      fVUncY(0), fVUncZ(0), fPX(0), fPY(0), fPZ(0), fPUncX(0), fPUncY(0),
      fPUncZ(0), fE0Calc(0), fE0CalcUnc(0), fArc(0), fArcUnc(0), fE1(0),
      fE1Unc(0), fE2(0), fE2Unc(0), fE3(0), fE3Unc(0), fClassID(0),
      fEventType(0), fEnergyBinID(0), fPrimaryEnergy(0), fEnergyLoss(0),
      fEnergyScattered(0) {
