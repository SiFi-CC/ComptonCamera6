...
DetPlane::DetPlane(Double_t a, Double_t b, Double_t c, Double_t d, Double_t dimZ, Double_t dimY,
                   TString name)
{
...
void DetPlane::Print(void)
{
    ...
    cout << "\tDimensions of the detector plane: " << fDimZ << "mm x " << fDimY << "mm" << endl;
    cout << "\tCartesian equation of the plane: " << fA << "x + " << fB << "y + " << fC << "z + "
         << fD << " = 0" << endl;
}
//------------------------------------------------------------------
