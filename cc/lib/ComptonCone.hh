...
/// object consists of 
///- apex (fApex) - point of interaction on the scatterer plane. It's coordiantes 
///are stored in TVector3
///- axis (fAxis) - it is calculated as vector connecting interaction points in the 
///scatterer and absorber. Coordiantes stored in TVector3
