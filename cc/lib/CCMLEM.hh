...
#include <TMatrixT.h>
#include <vector>
/// To be acquainted with Class for image reconstruction from events simulated
/// in class CCSimulations and using MLEM method based on ComptonCone class
/// objects. More details about this class
/// is available on wiki [LINK]
/// (http://bragg.if.uj.edu.pl/gccbwiki/index.php/File:MK_20180513_Image_Reconstruction_Analysis_For_CC_Toy_Model.pptx)
/// Moreover, it can be used for reconstruction of Geant4 and machine learning
/// outputs
...
private:
  ...
  Bool_t fSmear; ///< Smear flag for smearing energy and position only used for
                 ///< simple Simulation results
  Double_t fResolutionX; ///< Position resolution in direction x-axis only used
                         ///< for simple Simulation results
  Double_t fResolutionY; ///< Position resolution in direction y-axis only used
                         ///< for simple Simulation results
  Double_t fResolutionZ; ///< Position resolution in direction z-axis only used
                         ///< for simple Simulation results
  Double_t fP0; ///< Fitting parameter used for the energy smearing in simple
                ///< simulation
  Double_t fP1; ///< Fitting parameter used for the energy smearing in simple
                ///< simulation
  Double_t fP2; ///< Fitting parameter used for the energy smearing in simple
                ///< simulation

  /// GEANT4 SIMULATION INPUT
  Bool_t fLoadReal; ///< Flag if Real or Reco data is loaded from the input
  Bool_t fCorrectIdentified; ///< Indicates if only correct identified events
                             ///< from the Reco are loaded
  ...
  TClonesArray* fSM; ///< Array of information for intersection of all Compton
                     ///< cones with image plane

  InputReader*
      fReader; ///< InputReader to read different given input simulation files
