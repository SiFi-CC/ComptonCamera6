  ...
  for (Int_t i = fStart; i < fStop; i++) {
    ...
    for (j = 0; j <= fNbinsY; j++) {
      ...
      b = 2 * ((-coneAxis.Z()) * ((interactionPoint.Z()) * (-coneAxis.Z()) -
                                  ...
                                  (interactionPoint.X()) * (-coneAxis.X()) + F -
                                  (-coneAxis.X()) * F) -
      ...
      c2 = (-2) * (interactionPoint.X()) * F +
           4 * (interactionPoint.X()) * F * pow(-coneAxis.Z(), 2) -
           4 * (interactionPoint.Y()) * (-coneAxis.Y()) * F -
           4 * (interactionPoint.X()) * (-coneAxis.X()) * F +
           4 * (interactionPoint.Y()) * (-coneAxis.Y()) * (-coneAxis.X()) * F +
           4 * (interactionPoint.X()) * pow(-coneAxis.X(), 2) * F - pow(F, 2) -
           2 * pow(-coneAxis.Z(), 2) * pow(F, 2) +
           4 * (-coneAxis.X()) * pow(F, 2) -
           2 * pow(-coneAxis.X(), 2) * pow(F, 2);
      ...
      c4 = (pow(y, 2) - 2 * y * (interactionPoint.Y()) +
            pow(interactionPoint.Y(), 2) + pow((interactionPoint.X() - F), 2)) *
           ((-1) + 2 * pow(K, 2));
    ...
    for (k = 0; k <= fNbinsZ; k++) {
      ...
      f2 = (-2) * (interactionPoint.X()) * F +
           4 * (interactionPoint.X()) * F * pow(-coneAxis.Y(), 2) -
           4 * (interactionPoint.Z()) * (-coneAxis.Z()) * F -
           4 * (interactionPoint.X()) * (-coneAxis.X()) * F +
           4 * (interactionPoint.Z()) * (-coneAxis.Z()) * (-coneAxis.X()) * F +
           4 * (interactionPoint.X()) * pow(-coneAxis.X(), 2) * F - pow(F, 2) -
           2 * pow(-coneAxis.Y(), 2) * pow(F, 2) +
           4 * (-coneAxis.X()) * pow(F, 2) -
           2 * pow(-coneAxis.X(), 2) * pow(F, 2);
      ...
      f4 = (pow(z, 2) - 2 * z * (interactionPoint.Z()) +
            pow(interactionPoint.Z(), 2) + pow((interactionPoint.X() - F), 2)) *
           ((-1) + 2 * pow(K, 2));
...
void CCMLEM::Print(void) {
  ...
  cout << setw(35) << "Name of input file: \t"
       << "../sources/results/" + fInputName << endl;
