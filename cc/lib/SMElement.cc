...
//------------------------------------------------------------------
void SMElement::SetEvent(Int_t i){
  feventno=i;
}
//------------------------------------------------------------------
void SMElement::SetBin(Int_t b){
  fGlobalBin=b;
}
//------------------------------------------------------------------
void SMElement::SetDist(Double_t d){
  fdist=d;
}
//------------------------------------------------------------------
Int_t SMElement::GetEvent(void) const{
  return feventno;
}
//------------------------------------------------------------------
Int_t SMElement::GetBin(void) const{
  
  return fGlobalBin;
}
//------------------------------------------------------------------
Double_t SMElement::GetDist(void){
